...
def get_files_contents(url: str, minimal: bool = False) -> None:
    repo = g.get_repo("AbiramiSukumaran/alloydb-pgvector")
...
if __name__ == "__main__":
    print(get_files_contents("https://github.com/AbiramiSukumaran/alloydb-pgvector"))